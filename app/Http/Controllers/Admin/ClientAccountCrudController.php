...
use App\ClientAccountTemplates;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use App\Http\Requests\ClientAccountRequest as StoreRequest;
use App\Http\Requests\ClientAccountRequest as UpdateRequest;

class ClientAccountCrudController extends CrudController
{
    use ClientAccountTemplates;

    public function setup($template_name = false)
    {
        parent::__construct();

        $modelClass = 'App\Models\ClientAccount';
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/clientAccount');
        $this->crud->setEntityNameStrings('client account', 'client accounts');
    ...
    public function getTemplates($template_name = false)
    {
        ...
        $templates_trait = new \ReflectionClass('App\ClientAccountTemplates');
